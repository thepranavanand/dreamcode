...
int main(){
    ...
    int num1 , num2 ;
    cout<<"Enter two numbers one by one with very small difference between each other and we will tell you if its even or odd respectively or write it in english for you";
    cout<<endl;
    cin >> num1 >> num2;
